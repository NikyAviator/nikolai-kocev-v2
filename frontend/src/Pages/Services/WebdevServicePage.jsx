...
const product = {
  ...
  description: [
    ...
    'Need more than a static site? I can add a backend in Go, connect a database, and deploy the full application to the cloud. Whether you need a simple landing page or a full web application, I will scope it honestly, build it cleanly, and deliver something you can be proud of.',
  ],
